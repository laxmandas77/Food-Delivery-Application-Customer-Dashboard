                        ...
                        <div className="card-body">
                            {
                                ...
                                <div className="col-md-2">
                                    <div className="input-group">
                                        ...
                                        <input style={{ "maxWidth": "100px" }} type="text" className="form-control  form-control-sm text-center quantity-input" value={quantities[food.id]} />
                    ...
                    <div className="card cart-summary">
                        <div className="card-body">
                            ...
                            <div className="d-flex justify-content-between mb-4">
                                <strong>Total</strong>
                                <strong>&#8377;{subtotal === 0 ? 0 : total.toFixed(2)}</strong>
                            </div>
